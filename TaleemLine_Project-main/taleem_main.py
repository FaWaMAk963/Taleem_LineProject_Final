# FSM Control: Complete implementation matching the FSM diagram
# Uses Ollama (Llama3) for AI responses
# IDLE → LANG_SELECT → GRADE_SELECT → SUBJECT_SELECT → MODE_SELECT → 
# LEARNING_SESSION / TEST_SESSION / GAME_SESSION → END_SESSION → IDLE
...
class TaleemAgent:
    ...
    def get_greeting(self):
        ...
        greetings = {
            'Urdu': "Assalam-o-Alaikum! TaleemLine mein khush aamdeed. Main aapka ustad hoon. Poochna shuru karein.",
    ...
    def get_language_prompt(self):
        return "Press 1 for English, 2 for Urdu, 3 for Pashto"
    ...
    def get_student_input(self):
        ...
        if self.use_keyboard:
            ...
            if not text.strip():
                print("⚠️ Microphone failed. Switching to keyboard input.")
